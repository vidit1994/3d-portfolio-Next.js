...
export const experiences = [
  {
    ...
    points: [
      "Lead Developer responsible for managing a team of 5 developers, conducting code reviews with clients.",
       "Delegating work and assignments to teammembers.Additionally, guiding the team throughechnical issues while developing the UI.",
       "Manage and code review client code while delegating work to develop Figma Design into a properUI Guide the team through assisting other members with technical issues.",
       "Front-End team to develop the UI for the Self service Portalvfor AstraZeneca Doctor Using ReactJS, Recoil, Tailwind  CSS, Bootstrap"
    ],
  },
{
  title: "Full-Stack Developer",
    company_name: "TATA CONSUL TANCY SERVICE (Software Developer)",
      icon: okttrailer,
        iconBg: "#c0c0c0",
          date: "March 2017 - Sep 2021",
            points: [
             " Manage and code review client code, while delegating work to develop Figma Design into a proper UI.",
             "Guide the team through assisting other members with technical issues.",
             "Project Description: Migrating Open UI to ReactJS .",
             "SAS, working with TypeScript, ReactJS, Redux,Jest.",
            ],
  },
